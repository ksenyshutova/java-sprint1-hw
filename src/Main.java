...
public class Main {
    ...
    private static void printMenu() {
        System.out.println("Выберите необходимое действие: 1- Ввод количества шагов за определенный день, " +
                "2- Статистика за определенный месяц , 3- Изменение цели по количеству шагов в день," +
